...
class DbFixture:
    ...
    def get_contact_list(self):
        ...
        cursor = self.connection.cursor()
        try:
            cursor.execute("SELECT firstname, middlename, lastname, nickname, title, company, address, home, mobile, work, fax, email, email2, email3, homepage, byear, ayear, address2, phone2, notes, id FROM addressbook")
            for row in cursor:
